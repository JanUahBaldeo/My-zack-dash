...
const RoleSwitcher = () => {
  ...
  const enhancedRoles = roles.map(role => ({
    ...role,
    icon: role.id === 'User' ? FiUser : role.id === 'Admin' ? FiShield : FiUsers,
    color: role.id === 'User' ? 'text-blue-600' : role.id === 'Admin' ? 'text-red-600' : 'text-green-600',
    bgColor: role.id === 'User' ? 'bg-blue-50' : role.id === 'Admin' ? 'bg-red-50' : 'bg-green-50',
    borderColor: role.id === 'User' ? 'border-blue-200' : role.id === 'Admin' ? 'border-red-200' : 'border-green-200'
  }));
