  ...
  if (!tasksByCategory) {
    return (
      <motion.section
        ...
        className="tasks-section w-full px-2 sm:px-4 md:px-8 py-10 rounded-2xl border border-cyan-100 dark:border-cyan-900/40 shadow-xl dark:shadow-lg bg-white/70 dark:bg-gray-900/70 backdrop-blur-md"
      >
        <div className="flex items-center justify-center h-32">
          <div className="text-cyan-700 dark:text-cyan-300">Loading tasks...</div>
        </div>
      </motion.section>
    );
  }
